...
export default function LayoutWithHeaderFooter({ children, showBreadcrumbs = true }: LayoutWithHeaderFooterProps) {
  return (
    <>
      <Header />
      ...
      <footer className="border-t py-6 md:py-0 mt-8">
        <div className="container px-4 md:px-6 flex flex-col md:flex-row items-center justify-between gap-4 md:h-16">
        ...
        <div className="container mt-4 md:mt-2 pb-4 flex justify-center md:justify-end px-4 md:px-6">
